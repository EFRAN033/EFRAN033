<!-- Bloque de estilos para la animación -->
<style>
  ...
  .animated-text {
    font-size: 2.5em; /* Ajusta el tamaño según lo necesites */
    font-weight: bold;
...
<p align="center">
    <span class="animated-text">Desarrollo de software y sistemas inteligentes</span>
</p>
